package com.mobile.alliance.util;
...
public class ImageResizeUtils {
    private static String TAG = "NoCmplActivity ImageResizeUtils resizeFile";
    /**
     * 이미지의 너비를 변경한다.
     * @param file
     * @param newFile
    ...
    public static void resizeFile(File file, File newFile, int newWidth, Boolean isCamera) {
        ...
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                resizedBitmap.compress(Bitmap.CompressFormat.JPEG, 50, new FileOutputStream(newFile));
            }
            else {
                resizedBitmap.compress(Bitmap.CompressFormat.PNG, 50, new FileOutputStream(newFile));
            }
        }
    ...
    /*
    public static void resizeBitmap(Bitmap bitmap, File newFile, int newWidth) {
        Bitmap originalBm = null;
        Bitmap resizedBitmap = null;
