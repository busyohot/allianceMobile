...
public class SendTalkVO extends CommonVO
{
    ...
    public SendTalkVO.Button1 button1;
    @Getter
    @Setter
    @ToString(callSuper=true)
    ...
    public static class Button1{
        ...
        @SerializedName("url_mobile")   private String url_mobile;
        @SerializedName("url_pc")       private String url_pc;
    }
